...
class ProductPackaging(models.Model):
    ...
    # OVERRIDE: to preserve the precision historically provided from v18.0.
    volume = fields.Float(digits=(8, 4))
    ...
    def _compute_volume(self):
        ...
        if empty_dimension_packagings := self.filtered(
            ...
            # volume.
            return super(ProductPackaging, empty_dimension_packagings)._compute_volume()
