...
class TestProductMainVendor(SavepointCase):
    @classmethod
    def setUpClass(cls):
        super(TestProductMainVendor, cls).setUpClass()
    ...
    def test_main_vendor_1(self):
        """"Case 1: all the sellers share the same company."""
        self.assertEqual(self.product.main_vendor_id, self.seller_1)
        self.seller_2.sequence = -1
        self.assertEqual(self.product.main_vendor_id, self.seller_2)

    def test_main_vendor_2(self):
        ...
        self.assertEqual(
            self.product.with_company(self.company_2).main_vendor_id, self.seller_1
        )

    def test_main_vendor_3(self):
        ...
        self.assertEqual(self.product.main_vendor_id, self.seller_2bis)
