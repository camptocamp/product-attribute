...
Base module for calculating the amount of packaging needed to pack a certain quantity of product. That is calculated per packaging level (Eg. pallet, box, etc.)
