...
class TestProductMainSupplierInfo(SavepointCase):
    ...
    def test_main_supplierinfo_1(self):
        """"Case 1: all the sellers share the same company."""
        self.assertEqual(self.product.main_supplierinfo_id, self.seller_1)
        self.seller_2.sequence = -1
        self.assertEqual(self.product.main_supplierinfo_id, self.seller_2)

    def test_main_supplierinfo_2(self):
        ...
        self.assertEqual(
            self.product.with_company(self.company_2).main_supplierinfo_id,
            self.seller_1,
        )

    def test_main_supplierinfo_3(self):
        ...
        self.assertEqual(self.product.main_supplierinfo_id, self.seller_2bis)
