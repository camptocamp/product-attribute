...
class TestPackagingLevelCanBePurchased(Common):
    ...
    def test_product_packaging_can_be_purchased(self):
        ...
        exception_msg = (
            ...
            "as 'Purchases' in order to be used on a purchase order."
        ...
        self.packaging_cannot_be_purchased.purchases = True
        self.order_line.write(
            {"product_packaging_id": self.packaging_cannot_be_purchased.id}
        )
        ...
        self.assertEqual(self.packaging_cannot_be_purchased.purchases, False)
